...
#             if len(aCounts) < 2:
#                 logging.error("Invalid read counts data for allele {} (row {}) - is there only 1 row? {}".format(snp_order[idx], idx, aCounts))
#                 # raise SimpleException("Invalid read counts data for allele {} (row {}) - is there only 1 row?".format(snp_order[idx], idx))
#
