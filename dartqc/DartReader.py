...
#                 if row_index >= self._data_row and any(row) and row_index >= self._data_row + (bracket * size):
#
...
#                             raise SimpleException("Miss matched rows (" +str(row_index)+ "): " + clone_id + "(" + allele_id + ") -> " + row[
...
#                 row_index += 1
#
#                 if row_index > self._data_row + ((bracket + 1) * size) + 1:
#                     allele_index = 1
#                     break
#
#             if allele_index != 1:
